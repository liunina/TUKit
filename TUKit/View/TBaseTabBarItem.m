...
@implementation TBaseTabBarItem
...
- (void)_OTSTabBarItem_setupViews
{
    ...
    self.badgeLabel.backgroundColor = [TColor colorWithRGB:0xff3c25];
    ...
    self.indicateView.backgroundColor = [TColor colorWithRGB:0xff3c25];
...
{
    TBaseTabBarItem *item = [self viewWithFrame:CGRectZero];
